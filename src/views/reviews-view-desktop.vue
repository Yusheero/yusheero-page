    ...
    <div class="review-view-desktop">
      ...
      <div class="review-view-desktop__content">
        <div class="terminal-container">
          ...
          <!-- Контейнер с отзывами в сетке 3x3 -->
